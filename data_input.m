function [ ] = data_input(root_path, destination)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
             ...
             format_time = 'yyyy-mm-dd HH:MM:SS';
                 ...
                 folders = dir(root_path);
                  ...
                  warning('off','all')
                    ...
                    dbpath = 'H:\sqlite\imrtqa';
                  username = '';
                       pwd = '';
                       obj = 'org.sqlite.JDBC';
                       URL = 'jdbc:sqlite:H:\sqlite\imrtqa';
    ...
    tablename_planmetrics = 'planmetrics';
     colnames_planmetrics = {'numbeams','PLW','PA','PM','PI','PAGW','totalMU','fluencemap_path','fluencemap_filename','FK_RTplans_planmetrics' ...
            ...
            plan_dose_path = 'H:\imrtqadata_new\plan_dose\';
            meas_dose_path = 'H:\imrtqadata_new\meas_dose\';
            gamma_map_path = 'H:\imrtqadata_new\gamma_map\';
           fluencemap_path = 'H:\imrtqadata_new\planmetrics\';
...
total_steps = (pt_num_end - pt_num_start + 1)*250;
...
% -----------------------------------------------------------------------
   ...
   TPS_file = dir(strcat(root_path,folders(i).name,'\','RD*.dcm'));
